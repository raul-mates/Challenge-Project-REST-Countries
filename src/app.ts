...
} from "./renderers/render.country.details";
...
import { renderCountriesInListStyle } from "./renderers/list-style.renderer";
...
const fetchCountries = async (): Promise<void> => {
  const data = await genericFetch<CountryModel[]>(
  ...
  searchInputHandler();
  getCountryDetails();
  renderCountriesInListStyle(data);
};
